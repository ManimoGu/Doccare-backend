...
const {
  ...
  UpdateAssistante,
  AssistanteList,
  UpdateAvatarAssistante,
} = require("./API/Assistante");
const {
  PatientNbr,
  PatientList,
  AddPatient,
...
app.post(
  "/api/resetpasswordSetting/:login/code/:password",
  Access,
  reseSettingtPass
);

app.post(
  "/api/UploadFile/Nom/:Nom/Prenom/:Prenom/type/:type",
  Access,
  UploadFile
);
...
app.put(
  "/api/Doctor/AssistanteList/ChangePic/id/:id",
  Access,
  UpdateAvatarAssistante
);
...
app.get(
  "/api/Doctor/Patient_fiche_consultation/Cabinet/:idCabinet/Patient/:idPatient",
  Access,
  Patient_consultations
);
app.put(
  "/api/Doctor/Patient_fiche_consultation/AddFile/idFiche/:idFiche",
  PatientFiles
);
...
app.get(
  "/api/DoctorAssistante/UpdateType/id/:id/Patient/:Patient",
  Access,
  TypeUpdate
);
